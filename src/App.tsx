          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-lg text-gray-400 max-w-xl">
                Passionate full-stack developer currently pursuing my degree
                while building impactful web applications. Specialized in React,
              ...
              <div className="flex gap-4 text-gray-400">
                ...
                <a
                  href="mailto:sylvia.barick@example.com"
                  className="hover:text-blue-400 transition"
                >
                  <Mail size={24} />
                </a>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-gray-300">
                As a computer science student and self-driven developer, I
                combine academic knowledge with hands-on experience in building
                real-world applications. I'm passionate about creating intuitive
                user experiences and robust backend solutions using modern
                technologies.
              </p>
            </div>
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="border-l-2 border-blue-600 pl-4">
                  ...
                  <p className="text-gray-400">
                    Building web applications and gaining hands-on experience
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto max-w-5xl px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <ProjectCard
              ...
              link="https://github.com/sylvia-barick/alumniremastered"
            />
            <ProjectCard
              title="Amazon Clone"
              ...
              link="https://github.com/sylvia-barick/amazon"
            />
            <ProjectCard
              title="Tic Tac Toe"
              ...
              link="https://github.com/sylvia-barick/Tic-tac-toe"
            />
          </div>
        </div>
      </section>
